<template>
  <div class="factory-device-point" :style="Img">
    <div class="point-box" >
      <div class="point-img"  v-for="item of chartData" :key="item.deviceId" :style="{position:'absolute',left:item.xPercent+'%',top:item.yPercent+'%'}">
...
<!--          </div>-->
<!--        </div>-->
        <Point :deviceName=item.deviceName
  ...
  export default {
    ...
    data(){
      return{
        ...
        Img:{
          backgroundImage:"url("+require('@/assets/dashboard/factoryBg.jpg')+")",
