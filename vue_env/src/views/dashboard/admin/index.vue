      ...
      <el-col :span="7">
        ...
        <div class="weather-box">
          ...
          <div class="real-value">
            <WeatherTemp
              :chart-data="WeatherTempData"
              :style="{height:&quot;250px&quot;,width:&quot;50%&quot;}"
            />
            <WeatherHumi
              :chart-data="WeatherHumiData"
              :style="{height:&quot;250px&quot;,width:&quot;50%&quot;}"
            />
          </div>
        </div>
        <div class="i-title">
          <span class="i-lable" />大气实时状况
        </div>
        <div class="air-box">
...
import {
  getNoticeList,
  getAirDataList,
  getAirCalendarDataList,
  getWeatherData,
  getCurrentWeather,
  getFactoryDevicePoint
} from "@/api/dashboard";
...
const AirChartData = {
  ...
  AirListData: {
    ...
    O3AirListData: {
      myColor: "rgb(252,255,1)",
      dataName: "O3",
      dataValue: 0,
      maxValue: 1200
    },
    SO2AirListData: {
      myColor: "rgb(64,239,105)",
      dataName: "SO2",
      dataValue: 0,
      maxValue: 2600
    },
    PM10AirListData: {
      myColor: "rgb(232,37,5)",
      dataName: "PM10",
      dataValue: 0,
      maxValue: 600
    },
    PM25AirListData: {
      myColor: "rgb(3,167,243)",
      dataName: "PM2.5",
      dataValue: 0,
      maxValue: 250
    }
  ...
  methods: {
    ...
    handleSetLineChartData(type, val) {
      ...
      switch (type) {
        case "TSP":
          ...
          __.TSPAirListData.rateVaule = Math.round(
            (val / __.TSPAirListData.maxValue) * 100
          );
        case "O3":
          __.O3AirListData.dataValue = val;
          __.O3AirListData.rateVaule = Math.round(
            (val / __.O3AirListData.maxValue) * 100
          );
        case "SO2":
          __.SO2AirListData.dataValue = val;
          __.SO2AirListData.rateVaule = Math.round(
            (val / __.SO2AirListData.maxValue) * 100
          );
        case "PM10":
          __.PM10AirListData.dataValue = val;
          __.PM10AirListData.rateVaule = Math.round(
            (val / __.PM10AirListData.maxValue) * 100
          );
        case "PM25":
          __.PM25AirListData.dataValue = val;
          __.PM25AirListData.rateVaule = Math.round(
            (val / __.PM25AirListData.maxValue) * 100
          );
      }
    },
    // 预警实时消息
    ...
    async getAirCalendar() {
      try {
        ...
        __.startTime =
          ret.data.range[0] || diffDate(moment().format("YYYY-MM-DD"), 30, 2);
